...
$files = @(
    ...
    @{
        Uri = "https://github.com/AcademySoftwareFoundation/Imath/releases/download/v3.2.0/Imath-3.2.0.tar.gz"
...
$env:Path += ';C:\FlipFluidstmp\mingw64\bin;C:\FlipFluidstmp\cmake-3.30.2-windows-x86_64\cmake-3.30.2-windows-x86_64\bin;C:\FlipFluidstmp\python-3.12.5-embed-amd64;C:\FlipFluidstmp\Imath\Imath-3.2.0\bin;C:\FlipFluidstmp\alembic\alembic-1.8.8\bin;' 

# complie imath:
Write-Host "Start compiling/building Imath and alembic..."
cd C:\FlipFluidstmp\Imath\Imath-3.2.0
cmake . -G "MinGW Makefiles" -DCMAKE_INSTALL_PREFIX=C:\FlipFluidstmp\Imath\Imath-3.2.0\
cmake --build . --target install --config Release

#complie alimbic
cd C:\FlipFluidstmp\alembic\alembic-1.8.8
#$env:Path += 'C:\FlipFluidstmp\imathlibs\bin;'
cmake . -G "MinGW Makefiles" -DCMAKE_INSTALL_PREFIX=C:\FlipFluidstmp\alembic\alembic-1.8.8\ Imath_DIR=C:\FlipFluidstmp\Imath\Imath-3.2.0\lib\cmake\Imath
cmake --build .
